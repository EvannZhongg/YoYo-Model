...
used in `datasets/yoyo_dataset`. Boxes, polylines, masks, hands, and paths contain
...
contains `datasets/yoyo_dataset`, the target dataset during append, and previous
