...
def _draft_document(
    ...
    if string_model is not None:
        string = predict_runtime_string_model(
            ...
            semantic_inference_scale=TRACKING_CONFIG.string_inference_scale,
            wrists=[],
            color_probability_augment=TRACKING_CONFIG.string_color_probability_augment,
            color_probability_min_mean=TRACKING_CONFIG.string_color_probability_min_mean,
            color_probability_min_fraction=TRACKING_CONFIG.string_color_probability_min_fraction,
            color_semantic_prefilter=TRACKING_CONFIG.string_color_semantic_prefilter,
            bright_line_augment=TRACKING_CONFIG.string_bright_line_augment,
            bright_line_min_mean=TRACKING_CONFIG.string_bright_line_min_mean,
        )
...
def preannotate_dataset(dataset_path: str | Path, device: str | None = None) -> dict[str, Any]:
    ...
    string_model, string_status = load_runtime_string_model(
