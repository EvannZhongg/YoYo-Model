...
def _copyable_edit(annotation: dict[str, Any], reviewer: str) -> dict[str, Any]:
    return {
        "active_yoyo": annotation.get("active_yoyo"),
        "backup_yoyos": annotation.get("backup_yoyos") or [],
