...
def save_annotation_sample(
    ...
    presentation_orientation = str(
        edit.get("presentation_orientation")
        or document.get("presentation_orientation")
...
['yoyo-not-visible-reason','trick-orientation','presentation-orientation','string-visibility','review-status','notes'].forEach(name=>$("#yda-"+name).addEventListener("change",()=>{state.dirty=true;$("#yda-dirty").textContent="未保存";syncReviewButton();syncResetButton();}));
